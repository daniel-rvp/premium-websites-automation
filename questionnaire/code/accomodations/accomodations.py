ACOMMODATIONS = """import React from "react";
...
const defaultContent = {{
  header: {{
    title: "<accomodations-header-title/>",
    description: "<accomodations-header-description/>",
    imageUrl: "{accomodations_header_path}"
  }},
  accommodations: [
    {{
      title: "<accomodation1-title/>",
      description: "<accomodation1-description/>",
      imageUrl: "{accomodation_1_path}",
      features: [
    ...
    {{
      title: "<accomodation2-title/>",
      description: "<accomodation2-description/>",
      imageUrl: "{accomodation_2_path}",
      features: [
    ...
    {{
      title: "<accomodation3-title/>",
      description: "<accomodation3-description/>",
      imageUrl: "{accomodation_3_path}",
      features: [
    ...
    {{
      title: "<accomodation4-title/>",
      description: "<accomodation4-description/>",
      imageUrl: "{accomodation_4_path}",
      features: [
  ...
  ctaBanner: {{
    title: "<accomodations-cta-banner-title/>",
    description: "<accomodations-cta-banner-description/>",
    imageUrl: "{accomodations_cta_banner_path}",
    buttonText: "Book Now",
